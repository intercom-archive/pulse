...
RSpec.describe MetricsController, :type => :controller do
  ...
  let(:valid_attributes) {
    { title: "P95 Latency", datapoint_source: "graphite", datapoint_name: "stats.api.latency.p95" }
  }

  let(:invalid_attributes) {
    { title: "", datapoint_source: "fake_type", datapoint_name: "" }
  }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved metric as @metric" do
        post :create, {:metric => invalid_attributes}
        expect(assigns(:metric)).to be_a_new(Metric)
      end
